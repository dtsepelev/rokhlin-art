...
export class About extends Component {
  ...
  render() {
    return (
      <div>
        <div
          className={classNames(styles.imagesTop, 'col-lg-3', 'visible-lg-block')}
        >
          <div>
            <RetinaImage
              src='/images/am1.jpg'
        ...
        <div className={classNames(styles.imagesBottom, 'hidden-lg')}>
          <div className='col-sm-6 col-xs-12 col-lg-12'>
            <RetinaImage
              src='/images/am1.jpg'
              role='presentation'
              className={classNames(styles.image, 'img-responsive')}
